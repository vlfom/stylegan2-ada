...
def create_from_images(tfrecord_dir, image_dir, shuffle=True, use_labels=True):
    ...
    if use_labels:
        cat_map = {"tables": 0, "chairs": 1, "dressers": 2, "beds": 3, "sofas": 4}
        onehot = np.zeros((len(image_filenames), 5), dtype=np.float32)
